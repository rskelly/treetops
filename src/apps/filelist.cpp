...
void FileList::init(QWidget *parent, QPushButton *btnAddFiles, QPushButton *btnRemoveAllFiles, 
    ...
    connect(btnRemoveAllFiles, SIGNAL(clicked()), this, SLOT(removeAllFilesClicked()));
    connect(btnRemoveSelectedFiles, SIGNAL(clicked()), this, SLOT(removeSelectedFilesClicked()));
...
void FileList::updateButtons() {
    ...
    m_btnRemoveSelectedFiles->setEnabled(m_lstFiles->selectedItems().size() > 0);    
}
