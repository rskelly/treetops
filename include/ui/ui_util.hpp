...
namespace tt {
	...
	namespace ui {
		...
		namespace util {
			...
			void getTopsThresholds(QWidget* form, std::vector<tt::config::TopThreshold>& thresholds);

			void getCrownsThresholds(QWidget* form, std::vector<tt::config::CrownThreshold>& thresholds);
		}
